...
class Customer
{
	...
	public function __construct(Pagerfanta $data, UrlGeneratorInterface $urlGenerator )
	{
		...
		$this->addMeta('current_page', $urlGenerator->generate('api_customers_collection_get', [
		...
		if($data->hasPreviousPage()){
			...
			$this->addMeta('previous_page', $urlGenerator->generate('api_customers_collection_get', [
		...
		if($data->hasNextPage()){
			...
			$urlGenerator->generate('api_customers_collection_get', [
